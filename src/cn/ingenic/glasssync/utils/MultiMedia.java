...
public class MultiMedia extends Activity{
	...
	setContentView(R.xml.multimedia);
	setupViews();
	openFile();
    }
	...
	ListView listView = (ListView) this.findViewById(R.id.mmlv);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    convertView = LayoutInflater.from(getApplicationContext()).inflate(R.xml.mulstyle,null);

	      /*left*/
	    HashMap hm1 = mListItem.get(position * 2);
	      //Long id1 = (Long)hm1.get((Object)"id");
