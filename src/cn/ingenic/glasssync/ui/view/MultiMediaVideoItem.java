...
public class MultiMediaVideoItem extends FrameLayout 
    implements MyListView.OnRefreshListener {  
    private final String TAG = "MultiMediaVideoItem";
    private Context mContext;
    private MediaAdapter mVideoAdapter;
    private MyListView mDefaultView;
    private MyListView mVideoListView;
    private ArrayList<HashMap<String, Object>> mVideoListItem;

    private boolean mStopThread = false;
    private boolean mDisplayDefault = true;
    private final int MESSAGE_UPDATE_VIDEO_LIST = 1;
    ...
    private Handler mHandler = new Handler() {
		...
		switch(msg.what){
		case MESSAGE_UPDATE_VIDEO_LIST:
		    if(mDisplayDefault){
    ...
    public MultiMediaVideoItem(Context context) {  
	this(context, null);
    }  
  
    public MultiMediaVideoItem(Context context, AttributeSet attrs) {  
        super(context, attrs);  
	mContext = context;
        init(context);  
    }  
	...
	inflater.inflate(R.layout.fragment_item_media_video, this, true);

	mVideoListItem = new ArrayList<HashMap<String, Object>>();
	mVideoListView = (MyListView) findViewById(R.id.lv_video);

	mVideoAdapter = new MediaAdapter(context, mVideoListItem, true);
	mVideoListView.setAdapter(mVideoAdapter);
	mVideoListView.setonRefreshListener(this);

	mDefaultView = (MyListView)findViewById(R.id.default_video);
	...
	new Thread(new Runnable() {
		@Override
			...
			do {
				...
				Log.d(TAG, "--is video ");
				mVideoListItem.add(map);
				mHandler.sendEmptyMessage(MESSAGE_UPDATE_VIDEO_LIST);
			    }
	...
	public MyAdapter(Context context,ArrayList<HashMap<String, Object>> listItem) {
		...
		tv.setText(R.string.video_nofind);
