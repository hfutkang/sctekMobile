...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int dividerColor = 0x1A000000;
        private final int CURRENT_COLOR = getResources().getColor(R.color.blue_text_color);
    ...
    private int tabTextColor = getResources().getColor(R.color.tab_text_color);// 0xFF666666;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_dividerPaddinga, dividerPadding);
		...
		textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_textAllCapsa, textAllCaps);
	...
	private void updateTextColor(int position) {
	    ...
	    TextView currentV = (TextView)tabsContainer.getChildAt(position);
	    currentV.setTextColor(CURRENT_COLOR);
	...
	private void updateTabStyles() {
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if(i == 0)
				    tab.setTextColor(CURRENT_COLOR);
